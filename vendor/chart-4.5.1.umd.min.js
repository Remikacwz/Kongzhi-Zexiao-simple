...
/* school-detail badge auto inject */
(function(){
  function addSchoolBadge(){
    var h1=document.querySelector('header h1');
    if(!h1 || h1.querySelector('img')) return;
    var name=(h1.textContent||'').trim();
    if(!name) return;
    var img=document.createElement('img');
    img.src='../专业课选择/images/校徽/'+name+'.jpg';
    img.alt='';
    img.onerror=function(){ if(img.parentNode) img.parentNode.removeChild(img); };
    img.style.cssText='width:44px;height:44px;border-radius:50%;object-fit:cover;vertical-align:middle;flex:none;';
  ...
  if(document.readyState==='loading'){
    document.addEventListener('DOMContentLoaded', addSchoolBadge);
  } else {
    addSchoolBadge();
  }
})();
